...
![image tooltip here](/assets/flask/image_2.png)
...
![image tooltip here](/assets/flask/image_3.png)
...
![image tooltip here](/assets/flask/image_4.png)
...
![image tooltip here](/assets/flask/image_1.png)
...
![image tooltip here](/assets/flask/user_session/001_bcrypt.png)
...
![image tooltip here](/assets/flask/user_session/003_custom_validation_forms.png)

<br/>

The Login Manager instance is loaded into the app:

![image tooltip here](/assets/flask/user_session/004_login_manager.png)
...
![image tooltip here](/assets/flask/user_session/005_user_loader.png)
...
![image tooltip here](/assets/flask/user_session/006_nav_bar.png)
...
![image tooltip here](/assets/flask/user_session/007_register_check_user.png)

<br/>

Same applies for login page:

![image tooltip here](/assets/flask/user_session/008_login_check_user.png)
...
![image tooltip here](/assets/flask/user_session/002_check_user_and_password_in_db.png)
...
![image tooltip here](/assets/flask/user_account/009_update_username_email.png)

<br/>

We update the update form to add provision for updating picture:

![image tooltip here](/assets/flask/user_account/010_picture_form.png)
...
![image tooltip here](/assets/flask/user_account/011_account_route_code.png)
...
![image tooltip here](/assets/flask/user_account/012_save_picture.png)
...
![image tooltip here](/assets/flask/modify_post/013_update_form.png)

<br/>

Based on whether the user is logged in or not, the app displays the link to create a new post:

![image tooltip here](/assets/flask/modify_post/014_new_post_nav_bar.png)
...
![image tooltip here](/assets/flask/modify_post/015_new_post_route.png)
...
![image tooltip here](/assets/flask/modify_post/016_display_post.png)
...
![image tooltip here](/assets/flask/modify_post/017_update_post_route.png)
...
![image tooltip here](/assets/flask/modify_post/018_delete_post_route.png)
...
![image tooltip here](/assets/flask/pagination/019_pagination_arguments.png)
...
![image tooltip here](/assets/flask/pagination/020_display_page_count.png)
...
![image tooltip here](/assets/flask/reset_password/024_reset_forms.png)
...
![image tooltip here](/assets/flask/reset_password/025_generate_token.png)

<br/>

The below function handles the sending of email to the user. The send_reset_email() functions manages the operation:

![image tooltip here](/assets/flask/reset_password/026_reset_request_route.png)
...
![image tooltip here](/assets/flask/reset_password/030_reset_password_route.png)
...
![image tooltip here](/assets/flask/blueprint/031_create_app_blueprint.png)

<br/>

The below Config class contains all the config details:

![image tooltip here](/assets/flask/blueprint/032_config_class.png)

<br/>

The starting point for the app:

![image tooltip here](/assets/flask/blueprint/033_run_app.png)
...
![image tooltip here](/assets/flask/error_pages/034_error_handler.png)
...
![image tooltip here](/assets/flask/error_pages/035_error_page.png)
...
![image tooltip here](/assets/flask/error_pages/036_add_init.png)
